...
const getInfuraUrlFor = (network: string) =>`https://${network}.infura.io/v3/${process.env.REACT_APP_INFURA_KEY}`
const getAlchemyUrlFor = (network: string) => `https://${network}.alchemyapi.io/v2/${process.env.REACT_APP_ALCHEMY_KEY}` 
